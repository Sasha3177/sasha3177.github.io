...
/*
  ...
  Unterstützte Spalten für die Karten:
  - Titel
  - Beschreibung
  - Kategorie
  - Ort
...
function createOfferCard(offer) {
  ...
  const usernameValue = pickValue(offer, ['benutzername', 'user', 'username', 'anbieter', 'anbietername', 'name_des_anbieters']);
  const exchangeOrPriceValue = pickValue(offer, [
    'tauschwuensche_preis',
    'tauschwunsch_preis',
    'tauschwuensche_oder_preis',
    'tauschwuensche',
    'tauschwunsch',
    'preis',
    'price',
  ...
  if (usernameValue) {
    ...
    username.className = 'offer-user';
    username.textContent = `Von: ${usernameValue}`;
  ...
  if (exchangeOrPriceValue) {
    const exchangeOrPrice = document.createElement('p');
    exchangeOrPrice.className = 'offer-highlight';
    exchangeOrPrice.textContent = `Tauschwünsche / Preis: ${exchangeOrPriceValue}`;
    card.append(exchangeOrPrice);
  }
